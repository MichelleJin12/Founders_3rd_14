...
function init(){
 ...
 auction.charge_end( function(error, result){
document.getElementById("charge_end").innerHTML=result;
});
...
// 계약 만든사람만 볼수 있는걸 확인. 이더리움 특성으로 사기 불가능.
